...
namespace CoreDemo.Controllers
{
    public class RegisterController : Controller
    {
        ...
        [HttpPost]
        public IActionResult Index(Writer inputModel)
        {
            WriterValidator writerValid = new WriterValidator();
            ValidationResult result = writerValid.Validate(inputModel);
            if (result.IsValid)
            {
...
//Ekleme işlemi yapılırken httpget ve httppost attributelerin tanımlandığı methodların isimleri aynı olmak zorundadır.
